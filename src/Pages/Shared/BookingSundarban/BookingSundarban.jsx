...
const BookingSundarban = () => {
    return (
        <div className="hero min-h-screen relative w-full" style={{ backgroundImage: `url(https://res.cloudinary.com/dqyusvzi9/image/upload/v1706357690/qkih69dqaulr9dozqu5i.png)` }}>
                ...
                <div className="flex justify-between gap-20 w-full m-20">
                    <div className="text-white z-10 m-20 ">
                        ...
                        <p className="py-6">Sundarban is a town on the southeast coast of Bangladesh. It’s known for its very long, sandy beachfront, stretching from Sea Beach in the north to Kolatoli Beach in the south.
